            ...
            <div className="max-w-6xl mx-auto px-4 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-12">
                    ...
                    <div className="relative group">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-[32px] p-8 pt-12 h-full hover:border-purple-500/50 transition-colors">
                            ...
                            <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50">
                                <p className="text-xs text-slate-500 uppercase font-bold mb-2">Exemple</p>
                                <p className="text-sm text-slate-300 italic">"Quel est votre plus grand défi actuel avec votre trafic ?"</p>
                            </div>
                        </div>
                        <ArrowRight className="absolute -right-6 top-1/2 -translate-y-1/2 text-slate-800 hidden md:block w-8 h-8" />
                    </div>

                    {/* Step 2 */}
                    <div className="relative group">
                        <div className="absolute -top-6 -left-6 w-16 h-16 bg-slate-800 rounded-2xl flex items-center justify-center text-2xl font-bold text-white shadow-xl z-20 border border-slate-700 transition-transform group-hover:scale-110">
                            2
                        </div>
                        <div className="bg-slate-900 border border-slate-800 rounded-[32px] p-8 pt-12 h-full hover:border-blue-500/50 transition-colors">
                            ...
                            <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50">
                                <p className="text-xs text-slate-500 uppercase font-bold mb-2">Résultat</p>
                                <p className="text-sm text-slate-300 italic">+40% de taux d'opt-in par rapport à une landing classique.</p>
                            </div>
                        </div>
                        <ArrowRight className="absolute -right-6 top-1/2 -translate-y-1/2 text-slate-800 hidden md:block w-8 h-8" />
                    </div>
                    ...
                    <div className="relative group">
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-[32px] p-8 pt-12 h-full hover:border-green-500/50 transition-colors">
                            <div className="w-14 h-14 bg-green-500/10 rounded-2xl flex items-center justify-center mb-6 text-green-400">
                                <Gift className="w-7 h-7" />
                            </div>
                            <h3 className="text-2xl font-bold text-white mb-4">Conversion</h3>
                            <p className="text-slate-400 leading-relaxed mb-6">
                                Vous redirigez le prospect vers l'offre exacte qui correspond à son besoin (ou un appel commercial préparé).
                            </p>
                            <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50">
                                <p className="text-xs text-slate-500 uppercase font-bold mb-2">Impact</p>
                                <p className="text-sm text-slate-300 italic">Des appels avec des prospects éduqués et prêts à acheter.</p>
                            </div>
                        </div>
                    </div>
                </div>
