        ...
        <Section className="py-24">
            ...
            <div className="grid md:grid-cols-3 gap-6 auto-rows-[250px] max-w-6xl mx-auto px-4">
                        ...
                        <div className="my-8 flex-1 relative">
                            <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/4 scale-90 md:scale-100">
                                <div className="bg-background rounded-xl p-4 shadow-2xl w-64 space-y-3 transform rotate-[-5deg] border border-border">
                                    ...
                                    <div className="text-sm font-bold text-foreground">Nouveau Lead Qualifié ! 🚀</div>
                                    <div className="h-2 bg-muted rounded-full w-3/4">
                                        <div className="h-full bg-green-500 rounded-full w-full"></div>
                                    </div>
                                </div>
                                <div className="bg-background rounded-xl p-4 shadow-2xl w-64 space-y-3 transform rotate-[5deg] translate-y-4 border border-border absolute top-10 -z-10 opacity-50">
                ...
                <div className="bg-muted p-8 rounded-3xl border border-border shadow-xl hover:border-pink-500/30 transition-all flex flex-col items-start justify-between group">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-foreground mb-2">Optimisation Data</h3>
                        <p className="text-muted-foreground text-sm">Analyse des KPIs et itérations pendant 90 jours pour maximiser les résultats.</p>
                    </div>
                </div>
