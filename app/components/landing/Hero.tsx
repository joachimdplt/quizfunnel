            ...
            <div className="flex flex-col items-center text-center max-w-5xl mx-auto space-y-10">
                ...
                <div className="flex flex-col items-center space-y-3">
                    <div className="flex items-center justify-center -space-x-3">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="relative w-10 h-10 rounded-full border-2 border-slate-800 overflow-hidden shadow-sm">
                                <img
                    ...
                    <div className="flex flex-col items-center space-y-1">
                        <span className="font-semibold text-slate-400 text-sm">8+ clients satisfaits !</span>
                    ...
                    <span className="block mb-2 md:mb-4 md:whitespace-nowrap">
                        ...
                        <span className="whitespace-nowrap">
                            ...
                            <span className="relative inline-block mx-2">
                                ...
                                <svg className="absolute -top-8 -left-6 w-12 h-12 text-purple-400 bg-slate-900 rounded-lg p-1 shadow-sm rotate-[-15deg] z-20" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <span className="block md:whitespace-nowrap">
                        <span className="whitespace-nowrap">
                            ...
                            <span className="relative inline-block mx-2">
                                ...
                                <svg className="absolute -bottom-6 -left-6 w-12 h-12 text-purple-400 bg-slate-900 rounded-lg p-1 shadow-sm z-20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="text-xl md:text-2xl text-slate-400 max-w-2xl leading-relaxed">
                    Arrêtez de perdre vos visiteurs. Qualifiez, diagnostiquez et convertissez automatiquement chaque prospect avec un Quiz Funnel sur-mesure.
                </p>
